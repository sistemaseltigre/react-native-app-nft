...
const App: () => Node = () => {
  ...
  const createCollectionNft = async () => {
    ...
    let objTmp = {
      _contractName: "SolarSystem",
      _uri:"https://bafybeigrfsyjsgjcapbehtpfttm3z5arfs6amwo2ni4nz2pgcs65fb65di.ipfs.nftstorage.link/",
      _ids:[1,2,3,4,5,6,7,8],
      _names: ["Mercury","Venus","Earth", "Mars", "Neptune","Uranus","Saturn","Jupiter"],
    }

    const tx = await nftContract.deployERC1155(objTmp);
    console.log(tx);
  };
